# Generated by Django 2.2.16 on 2022-11-18 18:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'user'), ('moderator', 'moderator'), ('admin', 'admin')], default='user', max_length=16, verbose_name='Роль')),
                ('confirmation_code', models.CharField(max_length=5, verbose_name='Код подтверждения')),
